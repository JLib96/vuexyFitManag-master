<template>
  ...
  >
    ...
    <!-- Vertical Nav Menu Test menu -->
    <another-vertical-nav-menu
      v-if="!isNavMenuHidden"
      :is-vertical-menu-active="isVerticalMenuActive"
      :toggle-vertical-menu-active="toggleVerticalMenuActive"
...
import AnotherVerticalNavMenu from './components/vertical-nav-menu/VerticalNavMenu_copy.vue'
